    ...
    const elementosConsultor = [
        {
            ...
            items: [
                ...
                { label: 'Importar Candidatos', icon: 'pi pi-upload', route: '/importar', template: plantillaElemento }
            ]
        },
        {
            label: 'REPORTES',
            items: [
                ...
                { label: 'Reporte comparativo', icon: 'pi pi-copy', route: '/reportes/comparativo', template: plantillaElemento }
            ]
        },
        {
            label: 'PARÁMETROS DEL SISTEMA',
            items: [
                { label: 'Puesto / Funciones', icon: 'pi pi-briefcase', route: '/parametros/puestos', template: plantillaElemento },
                { label: 'Competencias', icon: 'pi pi-star', route: '/parametros/competencias', template: plantillaElemento },
                { label: 'Factores', icon: 'pi pi-filter', route: '/parametros/factores', template: plantillaElemento },
                { label: 'Preguntas', icon: 'pi pi-plus', route: '/preguntas', template: plantillaElemento }
            ]
        }
    ];
