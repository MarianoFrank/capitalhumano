...
const GenerateEvaluation = () => {
    ...
    const loadCandidates = async () => {
        ...
        try {
            const params = {
                ...
                ...(filters.firstName && { nombre: filters.firstName }),
                ...(filters.lastName && { apellido: filters.lastName }),
                ...(filters.candidateNumber && { numeroCandidato: filters.candidateNumber })
            };

            const response = await tmApi.get('/api/candidatos', { params });
    ...
    const loadPositions = async () => {
        try {
            const response = await tmApi.get('/api/puestos/seleccion');
    ...
    const handleFileUpload = async (event) => {
        ...
        setLoading(true);
        try {
            const response = await tmApi.post('/api/candidatos/importar', formData, {
    ...
    const handleGenerateEvaluation = async () => {
        ...
        try {
            ...
            const response = await tmApi.post('/api/evaluaciones/generar', payload);
