...
export default function BienvenidaConsultor() {
    ...
    const nombreUsuario = usuario?.nombre || usuario?.name || 'Consultor';
        ...
        <div className="w-full fadein">
            ...
            <div className="bg-primary text-primary-contrast border-round p-5 md:p-6 mb-5 flex flex-column gap-2 relative overflow-hidden">
                <div className="relative z-1">
                    ...
                    <p className="m-0 text-lg line-height-3" style={{ maxWidth: '800px', opacity: 0.9 }}>
                        Bienvenido a Capital Humano. Desde acá podés gestionar las evaluaciones por competencias, administrar tus candidatos y analizar los reportes de rendimiento.
                    </p>
                </div>
            ...
            <div className="grid">
                <div className="col-12 md:col-4 p-2">
                    <div className="surface-card border-1 surface-border border-round p-4 h-full flex flex-column hover:surface-hover transition-colors cursor-pointer" onClick={() => navigate('/evaluar')}>
                ...
                <div className="col-12 md:col-4 p-2">
                    <div className="surface-card border-1 surface-border border-round p-4 h-full flex flex-column hover:surface-hover transition-colors cursor-pointer" onClick={() => navigate('/preguntas/nueva')}>
                        <div className="flex align-items-center justify-content-center w-3rem h-3rem border-circle surface-ground text-primary mb-3">
                ...
                <div className="col-12 md:col-4 p-2">
                    <div className="surface-card border-1 surface-border border-round p-4 h-full flex flex-column hover:surface-hover transition-colors cursor-pointer" onClick={() => navigate('/reportes/orden-merito')}>
                        <div className="flex align-items-center justify-content-center w-3rem h-3rem border-circle surface-ground text-primary mb-3">
...
export const DashboardWelcome = BienvenidaConsultor;
